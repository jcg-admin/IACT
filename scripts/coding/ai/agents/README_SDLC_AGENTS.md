...
Issue generado:
  ...
  Story Points: 8
  Prioridad: P1
  Artefacto: docs/agent/planificacion_y_releases/ISSUE_20251106_150610.md
...
INFO - Execution log: docs/agent/tdd_logs/tdd_execution_*.json
INFO - Dashboard: docs/agent/tdd_logs/dashboard_*.md
```
...
Los agentes guardan sus outputs en `docs/agent/` organizados por fase:
...
# 2. Revisar planning
cat docs/agent/planning/ISSUE_*.md
...
- **Issues generados**: `docs/agent/planning/`
