...
relacionados: ["copilot_instructions.md"]
---
...
│   ├── copilot_instructions.md # Guía para AI agents
│   ├── claude_code_conventions.md # Este archivo
...
- [Copilot Instructions](copilot_instructions.md) - Guía general del proyecto
