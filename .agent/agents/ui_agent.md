...
- **Normativa CODEX**:
  ...
  - `docs/analisis/META_AGENTE_CODEX_PARTE_3.md` explica cómo consumir los artefactos generados, los formatos y métricas que deben entregarse al equipo de UI y las limitaciones que deben socializarse.
