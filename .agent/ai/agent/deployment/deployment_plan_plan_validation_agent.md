...
result = pipeline.execute({
    "issue_path": "docs/ai/agent/planificacion_y_releases/issue_feature_x.md"
})
...
- `docs/ai/agent/arquitectura/adrs_plan_validation_agent.md`
- `docs/ai/agent/diseno_detallado/lld_plan_validation_agent.md`
- `docs/ai/agent/testing/testing_strategy_plan_validation_agent.md`
- `docs/ai/agent/deployment/deployment_plan_plan_validation_agent.md` (this doc)
