# Analysis Report: template_requisito_no_funcional.md
...
- [HIGH] Broken internal link: ../necesidades/nXXX.md
- [HIGH] Broken internal link: ../stakeholders/rsXXX.md
- [LOW] 2 code blocks missing language identifier
