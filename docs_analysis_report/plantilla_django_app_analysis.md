# Analysis Report: plantilla_django_app.md
...
- [HIGH] Broken internal link: models.Model
- [HIGH] Broken internal link: APIView
- [HIGH] Broken internal link: ../../arquitectura/readme.md
- [HIGH] Broken internal link: database_design.md
- [HIGH] Broken internal link: api_reference.md
