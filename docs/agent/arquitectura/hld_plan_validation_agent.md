...
```python
{
    ...
    "output_dir": "docs/agent/validacion"
}
```
...
**Input Files**:
- `docs/agent/planificacion_y_releases/issue_*.md` (from SDLCPlannerAgent)

**Output Files**:
- `docs/agent/validacion/validation_report_{issue_id}.md`
- `docs/agent/validacion/validation_result_{issue_id}.json`
