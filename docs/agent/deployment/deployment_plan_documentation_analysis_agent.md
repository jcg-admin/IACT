...
- `docs/agent/requisitos/feasibility_documentation_analysis_agent.md`
- `docs/agent/arquitectura/hld_documentation_analysis_agent.md`
- `docs/agent/arquitectura/adrs_documentation_analysis_agent.md`
- `docs/agent/diseno_detallado/lld_documentation_analysis_agent.md`
- `docs/agent/testing/testing_strategy_documentation_analysis_agent.md`
- `docs/agent/deployment/deployment_plan_documentation_analysis_agent.md`
...
python -m scripts.cli.docs_analysis_agent docs/agent/testing .health_check
...
- **Issue Document**: `docs/agent/planificacion_y_releases/issue_documentation_analysis_agent.md`
- **HLD**: `docs/agent/arquitectura/hld_documentation_analysis_agent.md`
- **LLD**: `docs/agent/diseno_detallado/lld_documentation_analysis_agent.md`
- **Testing Strategy**: `docs/agent/testing/testing_strategy_documentation_analysis_agent.md`
