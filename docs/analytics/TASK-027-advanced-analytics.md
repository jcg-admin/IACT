...
if trend['trend_analysis']['direction'] == 'improving':
 ...
 print(f"ADVERTENCIA: Deployment frequency {trend['trend_analysis']['direction']}")
```
...
for metric, data in comparison['metrics'].items():
 ...
 print(f"ADVERTENCIA: {metric} degraded {data['percent_change']}%")
```
...
if anomalies['anomaly_rate'] > 10:
 print(f"ADVERTENCIA: High anomaly rate: {anomalies['anomaly_rate']}%")
