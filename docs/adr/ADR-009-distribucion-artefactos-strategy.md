# ADR-009: Estrategia de Distribución de Artefactos CPython Precompilados

**Estado:** Propuesto
**Fecha:** 2025-11-06
**Decisor:** Equipo Infraestructura
**Relacionado:** SPEC-INFRA-001, ADR-008
...
### Instalación:
Ver [documentación](https://github.com/2-Coatl/IACT---project/blob/main/docs/infraestructura/cpython-precompilado/README.md)
...
```bash
# .devcontainer/infrastructure/cpython/feature/install.sh
...
- [ADR-008: Features vs Imagen Base](./ADR-008-cpython-features-vs-imagen-base.md)
