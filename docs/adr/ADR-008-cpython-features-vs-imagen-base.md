# ADR-008: Usar Features de Dev Container vs Imagen Base Personalizada para CPython Precompilado

**Estado:** Propuesto
**Fecha:** 2025-11-06
**Decisor:** Equipo Infraestructura
**Relacionado:** SPEC-INFRA-001, ADR-009
...
La Feature se implementará en `.devcontainer/infrastructure/cpython/feature/` con:
...
3. Actualizar proyectos para usar `ghcr.io/2-Coatl/infrastructure/cpython/feature`
...
- [SPEC-INFRA-001](../specs/SPEC-INFRA-001-cpython-precompilado.md)
- [ADR-009: Distribución de Artefactos](./ADR-009-distribucion-artefactos-strategy.md)
