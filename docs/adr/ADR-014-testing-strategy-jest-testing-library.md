...
# ADR-014: Jest + Testing Library para Testing Frontend
...
- Requiere Vite (nosotros usamos Webpack - ADR-013)
- Documentación menor
...
Rechazado por:
- Requiere Vite (usamos Webpack - ADR-013)
- Ecosystem menor
- Menos adopción enterprise
...
- **ADR-012**: Redux Toolkit (slices fáciles de testear)
- **ADR-013**: Webpack (Babel transform para tests)
