...
# ADR-012: Redux Toolkit para State Management (no Context API)
...
- **ADR-011**: Modular Monolith (estructura permite slices por módulo)
- **ADR-013**: Webpack (code splitting para reducir bundle size)
