...
> **Nota de estado (2025-11-09):** la evaluación se realizó, pero tras contrastar con [ADR_011_frontend_modular_monolith](../../adr/ADR_011_frontend_modular_monolith.md) y [ADR-2025-009_frontend_postponement](../../adr/adr_2025_009_frontend_postponement.md) se determinó que la propuesta no se adoptará en esta etapa. El documento se conserva como análisis de opciones para un futuro posible.
