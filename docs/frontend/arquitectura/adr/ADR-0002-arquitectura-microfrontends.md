...
- Los equipos deberán empaquetar sus microfrontends como Web Components compatibles con single-spa, exponiendo hooks de limpieza para evitar fugas de memoria.
- Debemos documentar prefijos de URL, catálogos de rutas y eventos compartidos en la guía de arquitectura, además de sincronizar el backlog (`TODO.md`) con hitos de adopción de shell y SSR.
- SSR solo se habilitará en microfrontends con métricas de SEO o LCP exigentes; requiere coordinación con infraestructura para plantillas ESI/SSI.
