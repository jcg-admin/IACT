...
| **negocio/** | Requisitos de negocio específicos del frontend | RN-001, RN-002, ... |
...
Las **necesidades de negocio** (N-XXX) se documentan aquí en frontend porque:
...
## 🚀 Crear Nuevo Requisito Frontend
